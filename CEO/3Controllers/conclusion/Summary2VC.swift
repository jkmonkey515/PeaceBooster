...
class Summary2VC: BaseViewController {
    ...
    let questions: [String] = [
        ...
        "Only singular things that are full of their own essence can claim to have their own existence, such entities don't exist, which you discovered after completing Step #1.",
